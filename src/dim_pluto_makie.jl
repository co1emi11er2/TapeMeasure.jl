...
# ╠═╡ disabled = true
#=╠═╡
plot([1, 2, 3]ft, [1, 2, 3]ft, yerror=([3, 4, 1], [1, 2, 3]))
  ╠═╡ =#
...
# ╔═╡ 6d201fdc-c6e3-447f-8888-54186a7c514d
 xx = [
	 [2.5, 2.5, 3.7083333329999997, 3.7083333329999997, 2.666666667, 2.666666667, 5.333333333000001, 5.333333333000001, 4.291666667, 4.291666667, 5.5, 5.5, 2.5],
	 [10.5, 10.5, 11.708333333, 11.708333333, 10.666666667, 10.666666667, 13.333333333, 13.333333333, 12.291666667, 12.291666667, 13.5, 13.5, 10.5],
	 [18.5, 18.5, 19.708333333, 19.708333333, 18.666666667, 18.666666667, 21.333333333, 21.333333333, 20.291666667, 20.291666667, 21.5, 21.5, 18.5],
	 [26.5, 26.5, 27.708333333, 27.708333333, 26.666666667, 26.666666667, 29.333333333, 29.333333333, 28.291666667, 28.291666667, 29.5, 29.5, 26.5],
	 [34.5, 34.5, 35.708333333, 35.708333333, 34.666666667, 34.666666667, 37.333333333, 37.333333333, 36.291666667, 36.291666667, 37.5, 37.5, 34.5]
 ]

# ╔═╡ f694b3e0-945c-4001-b19e-082d2315d03a
yy = [
	[-0.25, -0.541666667, -0.875, -3.375, -4.020833333000001, -4.75, -4.75, -4.020833333000001, -3.375, -0.875, -0.541666667, -0.25, -0.25],
	[-0.25, -0.541666667, -0.875, -3.375, -4.020833333000001, -4.75, -4.75, -4.020833333000001, -3.375, -0.875, -0.541666667, -0.25, -0.25],
	[-0.25, -0.541666667, -0.875, -3.375, -4.020833333000001, -4.75, -4.75, -4.020833333000001, -3.375, -0.875, -0.541666667, -0.25, -0.25],
	[-0.25, -0.541666667, -0.875, -3.375, -4.020833333000001, -4.75, -4.75, -4.020833333000001, -3.375, -0.875, -0.541666667, -0.25, -0.25],
	[-0.25, -0.541666667, -0.875, -3.375, -4.020833333000001, -4.75, -4.75, -4.020833333000001, -3.375, -0.875, -0.541666667, -0.25, -0.25]
...
gx =[2.5, 2.5, 3.7083333329999997, 3.7083333329999997, 2.666666667, 2.666666667, 5.333333333000001, 5.333333333000001, 4.291666667, 4.291666667, 5.5, 5.5, 2.5]

# ╔═╡ c65aeb68-fd01-4171-a73e-a21cb626a369
...
right = dim_right(gx, gy)

# ╔═╡ 8273a5a2-0271-4500-a1f1-61c4454df15a
# ╠═╡ disabled = true
#=╠═╡
begin
	plot(gx, gy, seriestype=:shape, color=:lightgrey, legend=false, aspectratio=1)
	plot!(top)
	plot!(bot)
	plot!(left)
	plot!(right)
...
# ╔═╡ 7cab9729-4a75-4fd9-b569-6f76c1da4118
data = [[(1, "a"), (2, "b")], [(3, "c"), (4, "d")]]

# ╔═╡ fc6a6605-5f7f-41b5-ad9a-31cfd4165bc1
xxx, yyy = _convert_to_vectors(data)

# ╔═╡ 14573aba-0556-4469-921d-d3eebb82dcc6
xxx

# ╔═╡ 6bee6895-3fbf-4d4e-9dc1-63c03752b32c
x

# ╔═╡ 28887326-3a4c-4853-9552-5ce177d8672f
...
# ╔═╡ c393f34c-e6a5-4217-a83f-fc452d6a75d9
poly([(0ft, 0ft), (1ft, 1ft), (2ft, 3ft)])

# ╔═╡ 6aad9534-b340-4a13-821f-9b5fccb11791
n = Ngon((0, 0), (1, 1), (2, 3))

# ╔═╡ 0bf9e50f-bf04-4e8c-ac86-1fcb1306b2b5
plot(n)

# ╔═╡ 740662c7-9b63-41a7-b493-18f6f3d2d862
supertype(typeof(n))

# ╔═╡ a5125ce6-dbea-4565-b02f-d01370aca3a9
typeof(n)
...
manifest_format = "2.0"
project_hash = "fccecc51a752dda1ff76b12b02dc5ce4ba97792f"
...
git-tree-sha1 = "4bae058e2a8990a741f4aee86f0ca5e1a0ce255f"
...
git-tree-sha1 = "cc9cbf7252dc1a212d93e0ef510d75e0128dfaff"
